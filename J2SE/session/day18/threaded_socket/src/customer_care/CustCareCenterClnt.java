...
public class CustCareCenterClnt extends JFrame {
	...
	public CustCareCenterClnt() throws Exception {
	...
	private void initGUI(String title) throws Exception{
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				//upload center code & then coll of complaints
				out.writeUTF(centerCode);
				out.writeObject(complaints);
				} catch (Exception e1) {
					System.out.println("err in wc "+e1);
				} finally {
					if (s != null)
						try {
							s.close();
		...
		setVisible(true);
		//prompt for center code
		centerCode=JOptionPane.showInputDialog(this,"Enter Center code");
