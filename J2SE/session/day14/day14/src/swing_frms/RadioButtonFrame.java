...
public class RadioButtonFrame extends JFrame {
	...
	public RadioButtonFrame() {
		...
		plainJRadioButton.addItemListener(new ItemListener() {
		...
		boldJRadioButton.addItemListener(new ItemListener() {
		...
		italicJRadioButton.addItemListener(new ItemListener() {
		...
		boldItalicJRadioButton.addItemListener(new ItemListener() {
	...
	/*
	 * // private inner class to handle radio button events private class
	 * RadioButtonHandler implements ItemListener { private Font font; // font
	 * associated with this listener
	 * 
	 * public RadioButtonHandler( Font f ) { font = f; // set the font of this
	 * listener } // end constructor RadioButtonHandler
	 * 
	 * // handle radio button events public void itemStateChanged( ItemEvent
	 * event ) { textField.setFont( font ); // set font of textField } // end
	 * method itemStateChanged } // end private inner class RadioButtonHandler
	 */
