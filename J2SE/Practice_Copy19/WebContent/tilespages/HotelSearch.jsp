...
<title>HoteSearch</title>

</head>
<body bgcolor="cyan">
<h1><center>Plan Your Travel</center></h1>
...
<tr><td><input type="radio" name="type" value="1">AC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="type" value="2" checked="checked">NonAC
<tr><td>
...
<tr><td align="right"><input type="submit" name="cmd" value="searchHotels"><td>
</table>
</form>
</body>
</html>