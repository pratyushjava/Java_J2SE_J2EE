...
<d:graph_menubar id="menu3" selectedClass="tree-control-selected"
    ...
    <d:graph_menunode  name="Menu" label="Menu 3" >
        <d:graph_menunode  name="File" label="File 3" expanded="true">
            <d:graph_menunode  name="File-New" label="New 3" action="/components/demo-test.faces" />
            <d:graph_menunode  name="File-Open" label="Open 3" action="/components/demo-test.faces" />
            <d:graph_menunode  name="File-Close" label="Close 3" enabled="false" />
            <d:graph_menunode  name="File-Exit" label="Exit 3" action="/components/demo-test.faces" />
        </d:graph_menunode>

       <d:graph_menunode  name="Edit" label="Edit 3" >
           <d:graph_menunode  name="Edit-Cut" label="Cut 3" action="/components/demo-test.faces"/>
           <d:graph_menunode  name="Edit-Copy" label="Copy 3" action="/components/demo-test.faces" />
    ...
    <d:graph_treenode  name="Menu" label="Menu 5" enabled="false" 
        ...
        <d:graph_treenode  name="File" label="File 5"
            ...
            <d:graph_treenode  name="File-New" label="New 5"
                icon="folder_16_pad.gif" action="/components/demo-test.faces"/>
