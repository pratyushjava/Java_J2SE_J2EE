...
public class CreditCardConverter implements Converter {
   public Object getAsObject(FacesContext context, UIComponent component,
      ...
      if (builder.length() == 0)
      {
            FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_ERROR,"Card No Empty. ", " Can't Keep Card No blank");
      ...
      if (foundInvalidCharacter) {
         FacesMessage message = new FacesMessage("Card No Invalid", "Bad Credit Card Character "+invalidCharacter);//Messages.getMessage(               "jsfBean.messages", "badCreditCardCharacter",               new Object[]{ new Character(invalidCharacter) });
