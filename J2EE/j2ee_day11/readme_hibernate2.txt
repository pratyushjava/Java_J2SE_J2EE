...
Reverse Engineering approach ---- Generating Entities from Tables
Use JPA type of project
Create new DB connection
Create new User library (Manage Libraries) --hibernate library using hibernate jars.
Create Entities from DB
