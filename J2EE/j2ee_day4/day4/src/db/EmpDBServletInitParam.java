...
// @WebServlet("/emp_db1")
public class EmpDBServletInitParam extends HttpServlet {
	...
	public void init() throws ServletException {
		try {
			System.out.println("in init of DB independent servlet");
			System.out.println("drvr="+getServletConfig().getInitParameter("drvr"));
			System.out.println("ctx param "+getServletContext().getInitParameter("aa"));
		
			ServletConfig sc = getServletConfig();
			// load
			Class.forName(sc.getInitParameter("drvr"));
			// get cn
			String url = sc.getInitParameter("db_url");
			cn = DriverManager.getConnection(url,
					sc.getInitParameter("u_name"),
					sc.getInitParameter("u_pass"));
			// pst
