...
Meaning --- They provide the ability to encapsulate recurring tasks in reusable units.
 
2. Can dyn intercept req/resp to dyn or static content
...
Above called by WC --- only once during filter creation & initialization.
2.2 
