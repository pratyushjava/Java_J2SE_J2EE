...
public class UpdateInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			// re-direct user to main page : maintained for demo purpose only
			//better replacement is rd.forward(....)
			response.sendRedirect(response.encodeRedirectURL("display_info"));
		} catch (Exception e) {
